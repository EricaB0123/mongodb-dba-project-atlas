...
*/
    ...
    /*
        The ideas of this class is to make it easier to manage which databse and collections is being input by the user
        it should then make the code easer to read and maintain. Without having to manually list the database name.
